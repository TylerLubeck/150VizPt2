...
void example(){
    ...
    colorsrr[0] = new Color("RGB", 192, 81, 58);
    colorsrr[1] = new Color("RGB", 135, 204, 76);
    colorsrr[2] = new Color("RGB", 158, 94, 194);
    colorsrr[3] = new Color("RGB", 75, 64, 58);
    colorsrr[4] = new Color("RGB", 150, 159, 190);
    colorsrr[5] = new Color("RGB", 185, 156, 76);
    colorsrr[6] = new Color("RGB", 130, 193, 155);
    colorsrr[7] = new Color("RGB", 182, 81, 124);
